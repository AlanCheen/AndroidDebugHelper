...
internal class AdhFragmentLifecycleCallbacks : FragmentManager.FragmentLifecycleCallbacks() {
    ...
    override fun onFragmentPreAttached(fm: FragmentManager, f: Fragment, context: Context) {
        ...
        AdhLogger.log(
            "onFragmentPreAttached() called with: fm = $fm, f = $f, context = $context",
    ...
    override fun onFragmentAttached(fm: FragmentManager, f: Fragment, context: Context) {
        ...
        AdhLogger.log(
            "onFragmentAttached() called with: fm = $fm, f = $f, context = $context",
            tagSuffix = TAG_SUFFIX
        )
    }
    ...
    override fun onFragmentViewDestroyed(fm: FragmentManager, f: Fragment) {
        ...
        AdhLogger.log(
            "onFragmentViewDestroyed() called with: fm = $fm, f = $f",
            tagSuffix = TAG_SUFFIX
        )
    }
